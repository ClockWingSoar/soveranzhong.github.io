...
在系统设置中，找到"维护模式"选项，点击开启维护模式。![image-20251128162911307](/images/posts/2025-11-27-openkylin-ostree-pkgs-guard-fix.assets/image-20251128162911307.png)
...
1. **系统备份**：
   ...
   - 可以使用`ostree admin pin`命令固定当前系统版本，以便回滚
...
4. [OpenKylin系统中sudo apt install xxx报错的解决方法](https://blog.csdn.net/weixin_44688695/article/details/151836555)
